...
import { mapResultsToRecommendations } from "./utils/dataMapper";
...
export default function App() {
  ...
  const handleAISubmit = async (description: string, image?: File) => {
    ...
    try {
      const response = await searchJewelry({
        queryText: description || undefined,
        imageFile: image,
        dataset: "personalized",
        topK: 10,
      });

      const mappedResults = mapResultsToRecommendations("personalized", response.results);
        ...
        {!hasSearched && (
          <div className="max-w-4xl mx-auto mt-16 text-center">
            ...
            <p className="text-slate-600 max-w-xl mx-auto leading-relaxed">
              ...
              Simply describe your dream ring or upload an inspiration image to get started.
            </p>
          </div>
        )}
      </main>
